...
public class Observation implements Serializable {
    ...
    /*
    Static Method to generateFile
    will generate file based on the fileName given
    @param fileName
     */
    ...
    /*
    Static method to readFile
    Will read and populate the ArrayList<Observation>
    @fileName target file
    @rawData list to populate
     */
    public static void readFiles(String fileName, ArrayList<Observation>rawData){
        try {
